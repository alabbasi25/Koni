...
export const InventoryManager: React.FC = () => {
  const { inventory, addInventoryItem, updateInventoryStock, currentUser } = useKokab();
        ...
        <div className="glass-card p-4 bg-gradient-to-br from-blue-500/10 to-transparent border-blue-500/20">
          ...
          <AnimatePresence>
            {showRadar && (
              ...
              >
                <div className="p-3 rounded-lg bg-white/50 border border-blue-500/10 space-y-2">
                  ...
                  <button 
                    onClick={() => alert('تم إرسال التنبيه للشريك بنجاح.')}
