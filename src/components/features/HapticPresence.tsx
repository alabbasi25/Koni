...
export const HapticPresence: React.FC = () => {
  ...
  const sendPulse = (type: string) => {
    ...
    if ('vibrate' in navigator) {
      if (type === 'heart') navigator.vibrate([200, 100, 200, 100, 400]); // Heartbeat pattern
      else if (type === 'zap') navigator.vibrate(50);
      else if (type === 'appreciation') navigator.vibrate([100, 50, 100, 50, 100]); // Appreciation pattern
