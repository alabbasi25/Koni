      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            {myTasks.map(task => (
              <div key={task.id} className={`glass-card p-4 flex items-center justify-between gap-3 ${task.status === 'syncing' ? 'opacity-50' : ''}`}>
                <div className="flex items-center gap-3">
                  <button onClick={() => completeTask(task.id)} className={task.status === 'completed' ? 'text-green-500' : 'text-[var(--color-text-secondary)]'}>
                ...
                <button 
                  ...
                  className="p-2 rounded-lg hover:bg-[var(--color-bg-surface)] text-[var(--color-text-secondary)]"
                >
